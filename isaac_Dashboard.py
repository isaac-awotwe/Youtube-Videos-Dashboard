# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 15:08:12 2023
...
numeric_cols = np.array((df_agg_diff.dtypes == 'float') | (df_agg_diff.dtypes == 'int64'))
...
if add_sidebar=='Aggregate Metrics':
    ...
    for i in metric_medians6mo.index:
        with columns[count]:
            ...
            st.metric(label=i, value=round(metric_medians6mo[i]), delta="{:.2%}".format(delta))
            count+=1
            if count>=5:
                count=0
